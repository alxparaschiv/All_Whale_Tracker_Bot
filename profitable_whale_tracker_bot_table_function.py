#!/usr/bin/env python3
"""
Whale Position Info Bot - Telegram Command Version (Async)
...
class WhaleInfoBot:
    ...
    def __init__(self):
        ...
        # Allowed chat ID
        self.allowed_chat_id = int(TELEGRAM_CHAT_ID)
    ...
    def get_all_whale_positions(self):
        ...
        for whale in self.whales:
            ...
            # Whale header with clickable Coinglass link
...
']} {pos['side']}</b> {pnl_emoji}\n"
        ...
        if total_whales_with_positions == 0:
            ...
            message += f"<b>Legend:</b> 🟢 Long | 🔴 Short"
    ...
    async def start_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            "🤖 <b>Whale Position Info Bot Ready!</b>\n\n"
